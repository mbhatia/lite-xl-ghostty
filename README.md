...
For a new release, update `manifest.json` with the SHA-256 values generated by
the tag workflow before announcing LPM installs. Do not reuse a published tag
with a different binary after users can install it.
